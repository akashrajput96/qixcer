                                                ...
                                                @csrf
                                                    ...
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            ...
                                                            <input class="form--control" type="text" name="fb_url" value="{{Auth::guard('web')->user()->fb_url}}" placeholder="Type Your Facebook Link">
                                                        </div>
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Twitter Link')}} </label>
                                                            <input class="form--control" type="text" name="tw_url"  value="{{Auth::guard('web')->user()->tw_url}}"  placeholder="Type Your Twiter Link">
                                                        </div>
                                                    </div>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Google Link')}} </label>
                                                            <input class="form--control" type="text" name="go_url" value="{{Auth::guard('web')->user()->go_url}}" placeholder="Type Your Google Link">
                                                        </div>
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Youtube Link')}} </label>
                                                            <input class="form--control" type="text" name="yo_url"  value="{{Auth::guard('web')->user()->yo_url}}"  placeholder="Type Your Youtube Link">
                                                        </div>
                                                    </div>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Linkedin Link')}} </label>
                                                            <input class="form--control" type="text" name="li_url" value="{{Auth::guard('web')->user()->li_url}}" placeholder="Type Your Linkedin Link">
                                                        </div>
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Instragram Link')}} </label>
                                                            <input class="form--control" type="text" name="in_url"  value="{{Auth::guard('web')->user()->in_url}}"  placeholder="Type Your Instragram Link">
                                                        </div>
                                                    </div>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Dribble  Link')}} </label>
                                                            <input class="form--control" type="text" name="dr_url" value="{{Auth::guard('web')->user()->dr_url}}" placeholder="Type Your Dribble Link">
                                                        </div>
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Twitch Link')}} </label>
                                                            <input class="form--control" type="text" name="twi_url"  value="{{Auth::guard('web')->user()->twi_url}}"  placeholder="Type Your Twitch Link">
                                                        </div>
                                                    </div>
                                                    <div class="single-dashboard-input">
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Pinterest  Link')}} </label>
                                                            <input class="form--control" type="text" name="pi_url" value="{{Auth::guard('web')->user()->pi_url}}" placeholder="Type Your Pinterest Link">
                                                        </div>
                                                        <div class="single-info-input margin-top-30">
                                                            <label class="info-title"> {{__('Reddit Link')}} </label>
                                                            <input class="form--control" type="text" name="re_url"  value="{{Auth::guard('web')->user()->re_url}}"  placeholder="Type Your Reddit Link">
                                                        </div>
                                                    </div>
