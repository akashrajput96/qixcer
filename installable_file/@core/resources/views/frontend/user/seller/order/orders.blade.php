                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="mb-3 text-danger">
                            <li><strong>{{ 'Status Meaning:' }}</strong></li>
                            <li>{{ 'Pending: Did not start the job yet.' }}</li>
                            <li>{{ 'Active: Job already started.' }}</li>
                            <li>{{ 'Delivered: Order Deliverd For Checking.' }}</li>
                            <li>{{ 'Completed: Order is completed and closed.' }}</li>
                        </ul>
