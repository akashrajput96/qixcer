...
class BuyerController extends Controller
{
    ...
    {
        $orders = Order::with('online_order_ticket')->where('buyer_id', Auth::guard('web')->user()->id)->latest()->paginate(10);
    ...
    {
        $tickets = SupportTicket::where('buyer_id',Auth::guard('web')->user()->id)->orderBy('id','desc')->paginate(5);
